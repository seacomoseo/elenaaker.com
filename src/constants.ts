...
export const ASSETS = {
  photos: [
    { url: '/src/fotos/1.jpg', alt: 'Elena Aker - Retrato con arpa sinfónica', importance: 1, width: 853, height: 1280 },
    { url: '/src/fotos/2.jpg', alt: 'Elena Aker - Actuación en palacio', importance: 2, width: 1101, height: 1798 },
    { url: '/src/fotos/3.jpg', alt: 'Retrato de Elena Aker', importance: 3, width: 680, height: 945 },
    { url: '/src/fotos/4.jpg', alt: 'Elena Aker con arpa en entorno natural', importance: 4, width: 1080, height: 1920 },
    { url: '/src/fotos/5.jpg', alt: 'Sesión de fotos Elena Aker', importance: 5, width: 1280, height: 960 },
    { url: '/src/fotos/6.jpg', alt: 'Elena Aker en actuación en vivo', importance: 6, width: 853, height: 1280 },
    { url: '/src/fotos/museo-del-prado.jpg', alt: 'Elena Aker - Museo Nacional del Prado', importance: 7, width: 1200, height: 800 },
    { url: '/src/fotos/7.jpg', alt: 'Elena Aker - Retrato', importance: 8, width: 1920, height: 1280 },
    { url: '/src/fotos/8.jpg', alt: 'Elena Aker - Retrato artístico', importance: 9, width: 853, height: 1280 },
    { url: '/src/fotos/9.jpg', alt: 'Elena Aker - En directo', importance: 10, width: 1280, height: 853 },
    { url: '/src/fotos/10.jpg', alt: 'Elena Aker - Sesión fotográfica', importance: 11, width: 853, height: 1280 },
  ],
