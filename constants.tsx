...
export const ASSETS = {
  photos: [
    { url: '/src/fotos/1.webp', alt: 'Elena Aker - Retrato con arpa sinfónica', importance: 1 },
    { url: '/src/fotos/2.webp', alt: 'Elena Aker - Actuación en palacio', importance: 2 },
    { url: '/src/fotos/3.webp', alt: 'Elena Aker - Arpa celta en escena', importance: 3 },
    { url: '/src/fotos/4.webp', alt: 'Elena Aker - Interpretación urbana', importance: 4 },
    { url: '/src/fotos/5.webp', alt: 'Elena Aker - Arpa en la playa', importance: 5 },
    { url: '/src/fotos/6.webp', alt: 'Elena Aker - Calle en blanco y negro', importance: 6 },
    { url: '/src/fotos/museo-del-prado.webp', alt: 'Elena Aker - Museo Nacional del Prado', importance: 7 },
    { url: '/src/fotos/7.webp', alt: 'Elena Aker - Retrato', importance: 8 },
    { url: '/src/fotos/8.webp', alt: 'Elena Aker - Retrato artístico', importance: 9 },
    { url: '/src/fotos/9.webp', alt: 'Elena Aker - En directo', importance: 10 },
    { url: '/src/fotos/10.webp', alt: 'Elena Aker - Sesión fotográfica', importance: 11 },
  ],
  heroImg: '/src/fotos/7.webp',
  videoBg: '/src/video-background.mp4',
  videoPoster: '/src/video-background.webp',
  audio: '/src/audio/harp-dream-solo-arpa.mp3',
  bookingImg: '/src/contratacion.webp',
  icon: '/src/icon.png',
};
...
export const REVIEWS: ReviewItem[] = [
  ...
  },
  {
    id: 'mahler',
    date: '2004',
    image: '/src/fotos/adagietto-mahler.webp',
