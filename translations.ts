...
export const translations = {
  [Language.ES]: {
    ...
    bio: {
      ...
      extendedComposition: 'Paralelamente a su carrera interpretativa, desarrolla una sólida trayectoria creativa como compositora, productora musical, cantante, locutora y creadora audiovisual. Realiza producciones musicales incluyendo composición original, arreglos y música sincronizada para cine, publicidad y proyectos audiovisuales. Durante más de dos décadas ha trabajado en las principales cadenas de televisión españolas —TVE1, TVE2, Antena 3, Telecinco, Cuatro, Canal Plus y diversas plataformas digitales— tanto en funciones artísticas como de producción sonora.',
